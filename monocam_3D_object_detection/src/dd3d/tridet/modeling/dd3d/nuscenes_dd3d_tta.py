...
from dd3d.tridet.layers import bev_nms
from dd3d.tridet.modeling.dd3d.nuscenes_dd3d import NuscenesDD3D
from dd3d.tridet.modeling.dd3d.postprocessing import get_group_idxs, nuscenes_sample_aggregate
from dd3d.tridet.modeling.dd3d.test_time_augmentation import DatasetMapperTTA
...
class NuscenesDD3DWithTTA(nn.Module):
    def __init__(self, cfg, model, tta_mapper=None):
        ...
        if isinstance(model, DistributedDataParallel):
            model = model.module
        assert isinstance(model, NuscenesDD3D), \
