...
from dd3d.tridet.layers import IOULoss
from dd3d.tridet.layers.normalization import ModuleListDial, Scale
...
class FCOS2DHead(nn.Module):
    def __init__(self, cfg, input_shape):
        ...
        self.use_scale = cfg.DD3D.FCOS2D.USE_SCALE
        self.box2d_scale_init_factor = cfg.DD3D.FCOS2D.BOX2D_SCALE_INIT_FACTOR
        ...
        num_cls_convs = cfg.DD3D.FCOS2D.NUM_CLS_CONVS
        num_box_convs = cfg.DD3D.FCOS2D.NUM_BOX_CONVS
