...
class DD3DTargetPreparer():
    def __init__(self, cfg, input_shape):
        ...
        self.center_sample = cfg.DD3D.FCOS3D.PREPARE_TARGET.CENTER_SAMPLE
        self.strides = [shape.stride for shape in input_shape]
        self.radius = cfg.DD3D.FCOS3D.PREPARE_TARGET.POS_RADIUS
        self.dd3d_enabled = cfg.MODEL.BOX3D_ON

        # generate sizes of interest
        soi = []
        prev_size = -1
        for s in cfg.DD3D.SIZES_OF_INTEREST:
