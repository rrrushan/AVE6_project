...
write_folder = "/home/carla/admt_student/team3_ss23/AVE6_project/dd3d/outputs/extract_calib"
...
list_of_strings = []
for index, msg in enumerate(bag.read_messages(topics=['/arena_camera_node/image_raw/compressed'])):
...
with open('2023-05-05-09-37-26_cam_timestamp.txt', 'w') as f:
