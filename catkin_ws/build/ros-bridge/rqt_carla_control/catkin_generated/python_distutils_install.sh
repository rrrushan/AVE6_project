...
echo_and_run cd "/home/carla/carla-ros-bridge/catkin_ws/src/ros-bridge/rqt_carla_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/carla/carla-ros-bridge/catkin_ws/src/ros-bridge/rqt_carla_control/setup.py" \
     \
    build --build-base "/home/carla/carla-ros-bridge/catkin_ws/build/ros-bridge/rqt_carla_control" \
    install \
    --root="${DESTDIR-/}" \
