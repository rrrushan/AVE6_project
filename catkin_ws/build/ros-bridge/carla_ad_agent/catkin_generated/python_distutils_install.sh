...
echo_and_run cd "/home/carla/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/carla/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent/setup.py" \
     \
    build --build-base "/home/carla/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_ad_agent" \
    install \
    --root="${DESTDIR-/}" \
