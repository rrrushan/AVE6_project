...
from dd3d.tridet.modeling.dd3d.fcos2d import FCOS2DHead, FCOS2DInference, FCOS2DLoss
from dd3d.tridet.modeling.dd3d.fcos3d import FCOS3DHead, FCOS3DInference, FCOS3DLoss
from dd3d.tridet.modeling.dd3d.postprocessing import nuscenes_sample_aggregate
from dd3d.tridet.modeling.dd3d.prepare_targets import DD3DTargetPreparer
from dd3d.tridet.modeling.feature_extractor import build_feature_extractor
from dd3d.tridet.structures.image_list import ImageList
from dd3d.tridet.utils.tensor2d import compute_features_locations as compute_locations_per_level
from dd3d.tridet.modeling.backbone.omni_scripts.backbone_with_fpn import build_feature_extractor_all_fuse
...
class DD3D(nn.Module):
    ...
    def predict(self, batched_images, batched_intrinsic_mtx):     
        ...
        intrinsics = [x.to(self.device) for x in batched_intrinsic_mtx]
        ...
        for results_per_image, input_per_image, image_size in \
                zip(pred_instances, batched_images, images.image_sizes):
