...
import dd3d.tridet.modeling.dd3d
from dd3d.tridet.modeling import feature_extractor
from dd3d.tridet.modeling.dd3d import DD3DWithTTA, NuscenesDD3DWithTTA
