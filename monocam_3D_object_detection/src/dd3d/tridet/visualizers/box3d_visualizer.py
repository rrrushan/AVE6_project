...
from dd3d.tridet.structures.boxes3d import Boxes3D, GenericBoxes3D
from dd3d.tridet.structures.pose import Pose
from dd3d.tridet.utils.geometry import project_points3d
from dd3d.tridet.utils.visualization import change_color_brightness, draw_text, fill_color_polygon
from dd3d.tridet.visualizers.bev import BEVImage
from dd3d.tridet.visualizers.d2_visualizer import create_instances
...
def draw_boxes3d_cam(img, boxes3d, class_ids, metadata, intrinsics=None, scores=None, render_labels=True):
    ...
    boxes3d: dd3d.tridet.structures.Boxes3D or np.ndarray
