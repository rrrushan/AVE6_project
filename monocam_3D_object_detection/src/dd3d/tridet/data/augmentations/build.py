...
from dd3d.tridet.data.augmentations.color_transform import RandomBrightness, RandomContrast, RandomSaturation
from dd3d.tridet.data.augmentations.crop_transform import RandomCrop
from dd3d.tridet.data.augmentations.flip_transform import RandomFlip
from dd3d.tridet.data.augmentations.resize_transform import ResizeShortestEdge
...
def build_augmentation(cfg, is_train):
    ...
    if cfg.INPUT.COLOR_JITTER.ENABLED and is_train:
        ...
        brightness_min, brightness_max = 1. - brightness_lower, 1. + brightness_upper
        ...
        saturation_min, saturation_max = 1. - saturation_lower, 1. + saturation_upper
        ...
        contrast_min, contrast_max = 1. - contrast_lower, 1. + contrast_upper
