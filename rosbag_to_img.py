...
path_to_bag = "/home/carla/admt_student/team3_ss23/ROS_1/bags/evg_comp.bag"
# 2023-05-05-09-37-26.bag
# 2023-05-05-09-40-38.bag
# 2023-05-05-09-57-48.bag
write_folder = "/home/carla/admt_student/team3_ss23/ROS_1/bags/evg_img"
...
evg_topic = "/carla/ego_vehicle/rgb_front/image" # "sensor_msgs/Image"
# list_of_strings = []
for index, msg in tqdm.tqdm(enumerate(bag.read_messages(topics=[evg_topic]))):
